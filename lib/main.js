...
var MINUTE_AS_MILLISECOND = 60 * 1000;
var DAY_AS_MILLISECOND = 24 * 60 * MINUTE_AS_MILLISECOND;
...
function getWeeksAndDays() {
  var now = new Date();
  var nowTimezoneOffset = now.getTimezoneOffset() * MINUTE_AS_MILLISECOND;
  var startDateTimezoneOffset = START_DATE.getTimezoneOffset() * MINUTE_AS_MILLISECOND;
  
  var diff = (now.getTime() - nowTimezoneOffset) - (START_DATE.getTime() - startDateTimezoneOffset);
